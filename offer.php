    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <h1 class="h1">
                    Occation  <small>Offers</small></h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="well well-sm">
                <form action="sol.php?r=1 && in=3" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
                                Offer Occation</label>
                            <input type="text" class="form-control" name="occ" id="name" placeholder="Enter name" required="required" />
                        </div>
                        <div class="form-group">
                            <label for="email">
                                Offer Price(Minus from main price)</label>
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                </span>
                                <input type="text" name="price" class="form-control" id="email" placeholder="Enter email" required="required" /></div>
                        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <div class="well well-sm">
               <form action="sol.php?r=1 && in=4" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
...
if (mysqli_num_rows($result) > 0) 
{
	...
	{?>
      ...
      <li class="active"><a href="#one">Remove from All Category</a></li>
      <li><a href="#two">Remove From Particular  Category</a></li>
      ...
      <div class="tab-content">
        ...
        <form action="sol.php?r=1 && in=7" method="post">
         <center> <input type="submit"  class="btn btn-danger" style="padding:15px 25px 15px 25px" name="name" value=" Click Me To Remove Occation "></center>
          </form>
        </div>
        <div class="tab-pane" id="two">
        <form action="sol.php?r=1 && in=8" method="post">
          <select id="subject" name="cat" class="form-control" required="required">
                             <option value="" selected="">Choose One:</option>
        <?php
		include 'connection.php';
...
<br>
           ...
           <input type="submit"  class="btn btn-danger" style="padding:5px 25px 5px 25px" name="name" value="Submit ">
          </form>
        </div>    
      </div>
    </form>
