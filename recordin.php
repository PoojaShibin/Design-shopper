				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							<h3>Enter Records</h3>
                            <form action="sol.php?job=1 && in=10" method="post">
...
<div class="form-group row">
  <label for="example-search-input" class="col-2 col-form-label">Customer Address</label>
  <div class="col-10">
   <textarea rows="5" cols="50" name="add" ></textarea>
  </div>
</div>
<div class="form-group row">
  <label for="example-email-input" class="col-2 col-form-label">Customer Contact</label>
  <div class="col-10">
    <input class="form-control" type="text" name="phone" id="example-email-input">
  </div>
</div>
<div class="form-group row">
  <label for="example-url-input" class="col-2 col-form-label">Number of Items</label>
  <div class="col-10">
    <input class="form-control" type="number" name="item" min="1" max="50" id="example-url-input">
  </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
  <label for="example-password-input" class="col-2 col-form-label">Total Price</label>
  <div class="col-10">
    <input class="form-control" type="text" name="price"  id="example-password-input">
  </div>
</div>
<div class="form-group row">
  <label for="example-number-input" class="col-2 col-form-label">Order date</label>
  <div class="col-10">
    <input class="form-control" type="date" name="order" id="example-number-input">
  </div>
</div>
<div class="form-group row">
  <label for="example-datetime-local-input" class="col-2 col-form-label"> Delivery Date</label>
  <div class="col-10">
    <input class="form-control" type="date" name="del"  id="example-datetime-local-input">
  </div>
</div>
         <div class="form-group row">

  <div class="col-10">
    <input class="btn btn-success" type="submit" value=" Submit " style="padding:15px 25px 15px 25px" id="example-datetime-local-input">
  </div>
</div>                   <!-- List Ends--->
