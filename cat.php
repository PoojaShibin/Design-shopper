    ...
    <div class="row">
        <div class="col-md-8">
            <div class="well well-sm">
                <form action="sol.php?r=1 && in=2" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
                               Category Name</label>
                            <input type="text"  name="name" class="form-control" id="name" placeholder="Enter category  name" required="required" />
                        </div>
        ...
        <div class="col-md-4">
            <form>
            <legend><span class="glyphicon glyphicon-globe"></span> Existing Category</legend>
            <ul type="none">
            <?php
